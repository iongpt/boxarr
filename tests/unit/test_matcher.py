...
class TestMovieMatcher:
    ...
    def sample_radarr_movies(self) -> List[RadarrMovie]:
        ...
        return [
            RadarrMovie(
                id=1, title="The Dark Knight", tmdbId=155, year=2008, hasFile=True
            ),
            RadarrMovie(
                id=2,
            ...
            RadarrMovie(id=3, title="Inception", tmdbId=27205, year=2010, hasFile=True),
            RadarrMovie(
                id=4,
    ...
    def test_normalize_title(self, matcher):
        ...
        assert (
            matcher.normalize_title("Spider-Man: No Way Home")
            == "spiderman no way home"
        )
        assert (
            matcher.normalize_title("Avatar - The Way of Water")
    ...
    def test_confidence_threshold(self):
        ...
        movies = [
            RadarrMovie(id=1, title="The Amazing Spider-Man", tmdbId=1930, year=2012)
        ]
    ...
    def test_year_bonus(self, matcher):
        ...
        movies = [
            RadarrMovie(id=1, title="King Kong", tmdbId=254, year=2005),
            RadarrMovie(id=2, title="King Kong", tmdbId=857, year=1976),
        ]
